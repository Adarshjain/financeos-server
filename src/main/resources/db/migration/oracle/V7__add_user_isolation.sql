...
ALTER TABLE investment_transactions ADD user_id RAW(16);
...
ALTER TABLE gmail_sync_state ADD user_id RAW(16);
...
ALTER TABLE account_bank_details ADD user_id RAW(16);
...
ALTER TABLE account_credit_card_details ADD user_id RAW(16);
...
ALTER TABLE account_mutual_fund_details ADD user_id RAW(16);
...
ALTER TABLE account_stock_details ADD user_id RAW(16);
